  ...
  inner class BlastCLIDBFile {
    ...
    inner class BlastCLIDBFileJson {
      ...
      fun t1() {
        ...
        assertTrue(json[FlagDBFile].isTextual)
        assertEquals("hi", json[FlagDBFile].textValue())
      }
    }
    ...
    inner class BlastCLIDBFileCLIString {
      ...
      fun t1() {
        ...
        assertEquals("${tgt.tool.value} $FlagDBFile 'hi'", tgt.toCliString())
      }
    }
